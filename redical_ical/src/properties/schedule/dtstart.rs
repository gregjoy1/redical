...
impl ICalendarEntity for DTStartPropertyParams {
    define_property_params_ical_parser!(
        ...
        (
            ...
            |params: &mut DTStartPropertyParams, tzid_param: TzidParam| params.tzid = Some(tzid_param.0),
        ),
        (
            ValueParam::parse_ical,
            |params: &mut DTStartPropertyParams, value_param: ValueParam| params.value = Some(value_param.0),
        ),
        (
...
mod tests {
    ...
    fn parse_ical() {
        assert_parser_output!(
            DTStartProperty::parse_ical("DTSTART:19960401T150000Z".into()),
            (
                "",
                DTStartProperty {
