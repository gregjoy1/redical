                ...
                cut(
                    map_res(
                        ...
                        |(params, date_time)| {
                            ...
                            recurrence_id_property.resolve_dst_transitions()
...
mod tests {
    ...
    fn parse_ical_with_tz_dst_transition() {
        ...
        assert_parser_output!(
            RecurrenceIDProperty::parse_ical("RECURRENCE-ID;TZID=Pacific/Auckland:20240929T023000".into()),
            (
                "",
                RecurrenceIDProperty {
                    params: RecurrenceIDPropertyParams {
        ...
        assert_parser_output!(
            RecurrenceIDProperty::parse_ical("RECURRENCE-ID;TZID=Europe/London:20261025T011500".into()),
            (
                "",
                RecurrenceIDProperty {
                    params: RecurrenceIDPropertyParams {
