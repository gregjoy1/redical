                ...
                cut(
                    map_res(
                        ...
                        |(params, date_time)| {
                            ...
                            x_from_property.resolve_dst_transitions()
...
mod tests {
    ...
    fn parse_ical_with_tz_dst_transition() {
        ...
        assert_parser_output!(
            XFromProperty::parse_ical("X-FROM;TZID=Pacific/Auckland:20240929T023000".into()),
            (
                "",
                XFromProperty {
                    params: XFromPropertyParams {
        ...
        assert_parser_output!(
            XFromProperty::parse_ical("X-FROM;TZID=Europe/London:20261025T011500".into()),
            (
                "",
                XFromProperty {
                    params: XFromPropertyParams {
