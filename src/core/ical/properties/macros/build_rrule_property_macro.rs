    ...
    ($property_name:expr, $property_struct:ident) => {
        ...
        impl SerializableICalProperty for $property_struct {
            fn serialize_to_split_ical(&self, preferences: Option<&SerializationPreferences>) -> (String, Option<Vec<(String, String)>>, SerializedValue) {
                ...
                (String::from($property_struct::NAME), params, value)
            }
        }
            ...
            pub fn parse_ical(input: &str) -> ParserResult<&str, $property_struct> {
                preceded(
                    ...
                    cut(context(
                        Self::NAME,
                        tuple((
                            build_property_params_parser!($property_name),
        ...
        mod test {
            ...
            fn test_parse_ical_minimal() {
                assert_eq!(
                    $property_struct::parse_ical(concat!($property_name, ":FREQ=DAILY;COUNT=10;INTERVAL=2")),
                    Ok((
                        "",
                        $property_struct {
            ...
            fn test_parse_ical_full() {
                assert_eq!(
                    $property_struct::parse_ical(
                        concat!($property_name, r#";X-TEST-KEY-ONE=VALUE_ONE,"VALUE_TWO";X-TEST-KEY-TWO="KEY -🎄- TWO":FREQ=MONTHLY;INTERVAL=2;COUNT=10;WKST=SU;UNTIL=19971007T000000Z;BYSECOND=1,30;BYMINUTE=1,30;BYHOUR=1,6;BYDAY=-1SU,2WE;BYWEEKNO=20;BYMONTH=3,6;BYMONTHDAY=7,10;BYYEARDAY=1,30,60;BYEASTER=-1,3;BYSETPOS=3"#),
                    ),
                    Ok((
                        "",
                        $property_struct {
            ...
            fn test_parse_ical_full_with_lookahead() {
                assert_eq!(
                    $property_struct::parse_ical(
                        concat!($property_name, r#";X-TEST-KEY-ONE=VALUE_ONE,"VALUE_TWO";X-TEST-KEY-TWO="KEY -🎄- TWO":FREQ=MONTHLY;INTERVAL=2;COUNT=10;WKST=SU;UNTIL=19971007T000000Z;BYSECOND=1,30;BYMINUTE=1,30;BYHOUR=1,6;BYDAY=-1SU,2WE;BYWEEKNO=20;BYMONTH=3,6;BYMONTHDAY=7,10;BYYEARDAY=1,30,60;BYEASTER=-1,3;BYSETPOS=3 SUMMARY:Summary text."#),
                    ),
                    Ok((
            ...
            fn test_serialize_to_ical() {
                ...
                assert_eq!(
                    serialized_ical,
                    concat!($property_name, r#";X-TEST-KEY-ONE=VALUE_ONE,VALUE_TWO;X-TEST-KEY-TWO=KEY -🎄- TWO:BYDAY=-1SU,2WE;BYEASTER=-1,3;BYHOUR=1,6;BYMINUTE=1,30;BYMONTH=3,6;BYMONTHDAY=7,10;BYSECOND=1,30;BYSETPOS=3;BYWEEKNO=20;BYYEARDAY=1,30,60;COUNT=10;FREQ=MONTHLY;INTERVAL=2;UNTIL=19971007T000000Z;WKST=SU"#),
                );
            }
        }
    }
